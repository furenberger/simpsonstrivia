...
exports.handler = function (event, context) {
    try {
        ...
        if (event.session.application.applicationId !== "<yeah im not checking this in>") {
...
function getWelcomeResponse(callback) {
    var sessionAttributes = {},
        speechOutput = "I will ask you " + GAME_LENGTH.toString()
            + " Simpsons related questions, try to get as many right as you can. Just say the number of the answer. Let's begin. ",
    ...
    if (!gameInProgress) {
        ...
        if (currentQuestionIndex == GAME_LENGTH - 1) {
            ...
            speechOutput += speechOutputAnalysis + "You got " + currentScore.toString() + " out of "
                + GAME_LENGTH.toString() + " questions correct. Thank you for playing Simpsons Trivia!";
            callback(session.attributes,
...
function handleGetHelpRequest(intent, session, callback) {
    ...
    var speechOutput = "I will ask you " + GAME_LENGTH + " multiple choice questions related to the Simpsons. Respond with the number of the answer. "
