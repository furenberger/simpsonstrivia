...
function isAnswerSlotValid(intent) {
  ...
  console.log('answervalue: ', intent.slots.Answer.value);
...
const languageString = {
  en: {
    translation: {
      ...
      GAME_NAME: 'Simpsons Trivia',
      HELP_MESSAGE: 'I will ask you %s multiple choice questions related to the Simpsons dude. Respond with the number of the answer. For example, say one, two, three, or four. To start a new game at any time, say, start game. ',
      ...
      GAME_OVER_MESSAGE: 'You got %s out of %s questions correct. Thank you for playing Simpsons Trivia!',
...
const AnswerOnlyIntent = {
  canHandle(handlerInput) {
    return handlerInput.requestEnvelope.request.type === 'IntentRequest'
        && (handlerInput.requestEnvelope.request.intent.name === 'AnswerOnlyIntent'
        || handlerInput.requestEnvelope.request.intent.name === 'DontKnowIntent');
  },
  handle(handlerInput) {
    if (handlerInput.requestEnvelope.request.intent.name === 'AnswerOnlyIntent') {
      return handleUserGuess(false, handlerInput);
    }
    return handleUserGuess(true, handlerInput);
  },
